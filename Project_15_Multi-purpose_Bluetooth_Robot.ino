...
#define SCL_Pin  A5  //aktiverar Pin A5 som andvänds för clocka
#define SDA_Pin  A4  //aktiverar Pin A4 som andvänds för data
#define ML_Ctrl 4     //definerar riktningen för motor B
#define ML_PWM 5   //definerar hastigheten för motor B
#define MR_Ctrl 2    //definerar riktning för motor A
#define MR_PWM 9   //definerar hastigheten för motor A
#include <IRremote.h>//function library of IR remote control
int RECV_PIN = A0;// sätter på Pin A0 för IR remote
int speed = 220; // en int där man kan bestäma hastigheten av motorerna så man slipper ändra hastigheten på alla 

//här kontroleras å sätts remote controllen på
...
// bilens controller som styr saker som att åka fram bak sida och stannaui
void car_front()//car goes forward
{
  digitalWrite(ML_Ctrl,HIGH);//set direction control pin of B motor to HIGH level
  analogWrite(ML_PWM,speed);//Set PWM control speed of B motor to Speed
  digitalWrite(MR_Ctrl,HIGH);//set direction control pin of A motor to HIGH level
  analogWrite(MR_PWM,speed);//Set PWM control speed of A motor to Speed
}
